...
func (m *MockUserStore) CreateAndSendEmailVerification(ctx context.Context, user *User, token string, exp time.Duration) error {
	return nil
}

func (m *MockUserStore) Verify(ctx context.Context, t string) error {
	return nil
}
